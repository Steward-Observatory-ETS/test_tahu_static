...
int main(int argc, char *argv[]) {
  ...
  size_t message_length = encode_payload(&buf_ptr, 1024, &payload);

  // Publish the DDATA on the appropriate topic
  mosquitto_publish(mosq, NULL, "spBv1.0/dev/DCMD/Teensy1/led", message_length, binary_buffer, 0, false);
